...
export async function createKitMcpGsuiteClient(options: CreateClientOptions = {}): Promise<KitMcpGsuiteClient> {
  ...
  const client: KitMcpGsuiteClient = {
    ...
    async gsuite_email_messages_search(params: Parameters<KitMcpGsuiteTools['gsuite_email_messages_search']>[0]) {
      const tool = proxy.gsuiteEmailMessagesSearch as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_messages_search']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_message_label(params: Parameters<KitMcpGsuiteTools['gsuite_email_message_label']>[0]) {
      const tool = proxy.gsuiteEmailMessageLabel as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_message_label']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_message_unlabel(params: Parameters<KitMcpGsuiteTools['gsuite_email_message_unlabel']>[0]) {
      const tool = proxy.gsuiteEmailMessageUnlabel as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_message_unlabel']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_message_mark_read(params: Parameters<KitMcpGsuiteTools['gsuite_email_message_mark_read']>[0]) {
      const tool = proxy.gsuiteEmailMessageMarkRead as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_message_mark_read']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_message_mark_unread(params: Parameters<KitMcpGsuiteTools['gsuite_email_message_mark_unread']>[0]) {
      const tool = proxy.gsuiteEmailMessageMarkUnread as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_message_mark_unread']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_message_archive(params: Parameters<KitMcpGsuiteTools['gsuite_email_message_archive']>[0]) {
      const tool = proxy.gsuiteEmailMessageArchive as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_message_archive']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_message_trash(params: Parameters<KitMcpGsuiteTools['gsuite_email_message_trash']>[0]) {
      const tool = proxy.gsuiteEmailMessageTrash as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_message_trash']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_messages_batch_modify(params: Parameters<KitMcpGsuiteTools['gsuite_email_messages_batch_modify']>[0]) {
      const tool = proxy.gsuiteEmailMessagesBatchModify as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_messages_batch_modify']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_attachment_get(params: Parameters<KitMcpGsuiteTools['gsuite_email_attachment_get']>[0]) {
      const tool = proxy.gsuiteEmailAttachmentGet as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_attachment_get']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_attachment_metadata(params: Parameters<KitMcpGsuiteTools['gsuite_email_attachment_metadata']>[0]) {
      const tool = proxy.gsuiteEmailAttachmentMetadata as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_attachment_metadata']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_threads_search(params: Parameters<KitMcpGsuiteTools['gsuite_email_threads_search']>[0]) {
      const tool = proxy.gsuiteEmailThreadsSearch as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_threads_search']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_thread_unlabel(params: Parameters<KitMcpGsuiteTools['gsuite_email_thread_unlabel']>[0]) {
      const tool = proxy.gsuiteEmailThreadUnlabel as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_thread_unlabel']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_thread_mark_read(params: Parameters<KitMcpGsuiteTools['gsuite_email_thread_mark_read']>[0]) {
      const tool = proxy.gsuiteEmailThreadMarkRead as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_thread_mark_read']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_thread_mark_unread(params: Parameters<KitMcpGsuiteTools['gsuite_email_thread_mark_unread']>[0]) {
      const tool = proxy.gsuiteEmailThreadMarkUnread as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_thread_mark_unread']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_email_thread_archive(params: Parameters<KitMcpGsuiteTools['gsuite_email_thread_archive']>[0]) {
      const tool = proxy.gsuiteEmailThreadArchive as (
        args: Parameters<KitMcpGsuiteTools['gsuite_email_thread_archive']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_sheet_values_update(params: Parameters<KitMcpGsuiteTools['gsuite_sheet_values_update']>[0]) {
      const tool = proxy.gsuiteSheetValuesUpdate as (
        args: Parameters<KitMcpGsuiteTools['gsuite_sheet_values_update']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_calendar_calendars_list(params: Parameters<KitMcpGsuiteTools['gsuite_calendar_calendars_list']>[0]) {
      const tool = proxy.gsuiteCalendarCalendarsList as (
        args: Parameters<KitMcpGsuiteTools['gsuite_calendar_calendars_list']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_calendar_events_list(params: Parameters<KitMcpGsuiteTools['gsuite_calendar_events_list']>[0]) {
      const tool = proxy.gsuiteCalendarEventsList as (
        args: Parameters<KitMcpGsuiteTools['gsuite_calendar_events_list']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_calendar_event_create(params: Parameters<KitMcpGsuiteTools['gsuite_calendar_event_create']>[0]) {
      const tool = proxy.gsuiteCalendarEventCreate as (
        args: Parameters<KitMcpGsuiteTools['gsuite_calendar_event_create']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
    ...
    async gsuite_calendar_event_update(params: Parameters<KitMcpGsuiteTools['gsuite_calendar_event_update']>[0]) {
      const tool = proxy.gsuiteCalendarEventUpdate as (
        args: Parameters<KitMcpGsuiteTools['gsuite_calendar_event_update']>[0]
      ) => Promise<unknown>
      const raw = await tool(params)
      return wrapCallResult(raw).callResult
    },
